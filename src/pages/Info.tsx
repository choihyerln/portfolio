  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6">
        {/* 메인페이지로 이동 */}
        <div className="w-108 h-64 bg-[url(/assets/images/main/businessCard.png)] bg-cover pl-10 pr-24 py-14 flex justify-between items-end">
        ...
        {/* INFO */}
        <div className="w-108 h-64 bg-[url(/assets/images/main/businessCard.png)] bg-cover p-6 flex flex-col justify-between">
